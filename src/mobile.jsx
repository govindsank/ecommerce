...
<div className="row intro">
 <div className="col-3 box iphone"> <a href="/"><h1>IPHONE</h1></a></div>
  <div className="col-3 box"><a href="/"><h1>Samsung</h1></a></div>
  <div className="col-3 box"><a href="/"><h1>Vivo</h1></a></div>
  <div className="col-3 box"><a href="/"><h1>Realme</h1></a></div>
<div className="row">
  <div className="col-3 box boximage">
    <div className="row"><img src="./image/mobile/iphone.jpg"className=" samsung"/></div>
   <div className="row"> <center><h2>Iphone 15 Pro</h2></center></div>
